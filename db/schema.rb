...
ActiveRecord::Schema.define(version: 20170609205115) do
  ...
  create_table "dive_entries", force: :cascade do |t|
  ...
  create_table "environmental_studies", force: :cascade do |t|
    t.string "study_name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "environmental_study_locations", force: :cascade do |t|
    t.integer "location_id", null: false
  ...
  create_table "environmental_study_questions", force: :cascade do |t|
  ...
  create_table "environmental_study_responses", force: :cascade do |t|
    t.string "response"
